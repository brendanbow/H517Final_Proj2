function plots(key) {
    ...
    if (key === "lung") {
        document.getElementById("clinicalbox_svg").innerHTML = "";
        document.getElementById("clinicalboxtumor_svg").innerHTML = "";
        document.getElementById("clinicalpie_svg").innerHTML = "";
        document.getElementById("clinicalpierace_svg").innerHTML = "";
        document.getElementById("clinicalpievital_svg").innerHTML = "";
        document.getElementById("clinicalpiemalign_svg").innerHTML = "";
        return null;
    }
    ...
    d3.csv("data/Compendium_Clinical.csv", function (data) {
        ...
        data.forEach(function (l_data) {
            if ((l_data.project_id == key) || (key == 1))
            {
                ...
                if (l_data.gender.trim() == "male")
                    maleCount = maleCount + 1
                else
                    femaleCount = femaleCount + 1

                if (l_data.race == race[0])
                    raceData[0] = raceData[0] + 1;
                else if (l_data.race == race[1])
                    raceData[1] = raceData[1] + 1;
                else if (l_data.race == race[2])
                    raceData[2] = raceData[2] + 1;
                else if (l_data.race == race[3])
                    raceData[3] = raceData[3] + 1;
                else if (l_data.race == race[4])
                    raceData[4] = raceData[4] + 1;
                else
                    raceData[5] = raceData[5] + 1;

                if (l_data.vital_status == vitals[0])
                    vitalsReport[0] = vitalsReport[0] + 1;
                else if (l_data.vital_status == vitals[1])
                    vitalsReport[1] = vitalsReport[1] + 1;
                else
                    vitalsReport[2] = vitalsReport[2] + 1;

                if (l_data.prior_malignancy.toUpperCase() == malignant[0])
                    malignantReport[0] = malignantReport[0] + 1;
                else if (l_data.prior_malignancy.toUpperCase() == malignant[1])
                    malignantReport[1] = malignantReport[1] + 1;
                else
                    malignantReport[2] = malignantReport[2] + 1;

                if (l_data.tumor_stage == tumor[0])
                    tumorReport[0] = tumorReport[0] + 1;
                else if (l_data.tumor_stage == tumor[1])
                    tumorReport[1] = tumorReport[1] + 1;
                else if (l_data.tumor_stage == tumor[2])
                    tumorReport[2] = tumorReport[2] + 1;
                else if (l_data.tumor_stage == tumor[3])
                    tumorReport[3] = tumorReport[3] + 1;
                else
                    tumorReport[4] = tumorReport[4] + 1;
